...
@scall Ptr{vtkCgShader} vtkCgShaderNew () _ZN11vtkCgShader3NewEv "libvtkRendering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN11vtkCgShader8IsTypeOfEPKc "libvtkRendering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkCgShader} SafeDownCast (Ptr{vtkObjectBase},) _ZN11vtkCgShader12SafeDownCastEP13vtkObjectBase "libvtkRendering"
