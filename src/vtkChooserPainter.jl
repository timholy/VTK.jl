...
@scall Ptr{vtkChooserPainter} vtkChooserPainterNew () _ZN17vtkChooserPainter3NewEv "libvtkRendering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN17vtkChooserPainter8IsTypeOfEPKc "libvtkRendering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkChooserPainter} SafeDownCast (Ptr{vtkObjectBase},) _ZN17vtkChooserPainter12SafeDownCastEP13vtkObjectBase "libvtkRendering"
