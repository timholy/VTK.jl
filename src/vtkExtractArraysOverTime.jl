...
@scall Ptr{vtkExtractArraysOverTime} vtkExtractArraysOverTimeNew () _ZN24vtkExtractArraysOverTime3NewEv "libvtkGraphics"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN24vtkExtractArraysOverTime8IsTypeOfEPKc "libvtkGraphics"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkExtractArraysOverTime} SafeDownCast (Ptr{vtkObjectBase},) _ZN24vtkExtractArraysOverTime12SafeDownCastEP13vtkObjectBase "libvtkGraphics"
