...
@mcall Ptr{vtkGaussianSplatter} NewInstance () vtkGaussianSplatter _ZNK19vtkGaussianSplatter11NewInstanceEv "libvtkImaging"
...
@mcall None SetSampleDimensions (Int32, Int32, Int32) vtkGaussianSplatter _ZN19vtkGaussianSplatter19SetSampleDimensionsEiii "libvtkImaging"
@mcall None SetSampleDimensions (Ptr{Int32},) vtkGaussianSplatter _ZN19vtkGaussianSplatter19SetSampleDimensionsEPi "libvtkImaging"
...
@mcall None SetAccumulationModeToMin () vtkGaussianSplatter _ZN19vtkGaussianSplatter24SetAccumulationModeToMinEv "libvtkImaging"
@mcall None SetAccumulationModeToMax () vtkGaussianSplatter _ZN19vtkGaussianSplatter24SetAccumulationModeToMaxEv "libvtkImaging"
@mcall None SetAccumulationModeToSum () vtkGaussianSplatter _ZN19vtkGaussianSplatter24SetAccumulationModeToSumEv "libvtkImaging"
@mcall Ptr{Uint8} GetAccumulationModeAsString () vtkGaussianSplatter _ZN19vtkGaussianSplatter27GetAccumulationModeAsStringEv "libvtkImaging"
@vcall 109 None SetNullValue (Float64,) vtkGaussianSplatter
@vcall 110 Float64 GetNullValue () vtkGaussianSplatter
@mcall None ComputeModelBounds (Ptr{vtkDataSet}, Ptr{vtkImageData}, Ptr{vtkInformation}) vtkGaussianSplatter _ZN19vtkGaussianSplatter18ComputeModelBoundsEP10vtkDataSetP12vtkImageDataP14vtkInformation "libvtkImaging"
...
@mcall None Cap (Ptr{vtkDoubleArray},) vtkGaussianSplatter _ZN19vtkGaussianSplatter3CapEP14vtkDoubleArray "libvtkImaging"
@mcall Float64 Gaussian (Ptr{Float64},) vtkGaussianSplatter _ZN19vtkGaussianSplatter8GaussianEPd "libvtkImaging"
@mcall Float64 EccentricGaussian (Ptr{Float64},) vtkGaussianSplatter _ZN19vtkGaussianSplatter17EccentricGaussianEPd "libvtkImaging"
@mcall Float64 ScalarSampling (Float64,) vtkGaussianSplatter _ZN19vtkGaussianSplatter14ScalarSamplingEd "libvtkImaging"
@mcall Float64 PositionSampling (Float64,) vtkGaussianSplatter _ZN19vtkGaussianSplatter16PositionSamplingEd "libvtkImaging"
@mcall None SetScalar (Int32, Float64, Ptr{vtkDoubleArray}) vtkGaussianSplatter _ZN19vtkGaussianSplatter9SetScalarEidP14vtkDoubleArray "libvtkImaging"
@mcall None vtkGaussianSplatter_eq (Void,) vtkGaussianSplatter _ZN19vtkGaussianSplatteraSERKS_ "libvtkImaging"
