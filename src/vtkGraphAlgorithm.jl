...
@scall Ptr{vtkGraphAlgorithm} vtkGraphAlgorithmNew () _ZN17vtkGraphAlgorithm3NewEv "libvtkFiltering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN17vtkGraphAlgorithm8IsTypeOfEPKc "libvtkFiltering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkGraphAlgorithm} SafeDownCast (Ptr{vtkObjectBase},) _ZN17vtkGraphAlgorithm12SafeDownCastEP13vtkObjectBase "libvtkFiltering"
