...
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN18vtkImplicitBoolean8IsTypeOfEPKc "libvtkFiltering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkImplicitBoolean} SafeDownCast (Ptr{vtkObjectBase},) _ZN18vtkImplicitBoolean12SafeDownCastEP13vtkObjectBase "libvtkFiltering"
@vcall 15 Ptr{vtkObjectBase} NewInstanceInternal ()
@mcall Ptr{vtkImplicitBoolean} NewInstance () _ZNK18vtkImplicitBoolean11NewInstanceEv "libvtkFiltering"
@vcall 4 None PrintSelf (Void, vtkIndent)
@scall Ptr{vtkImplicitBoolean} vtkImplicitBooleanNew () _ZN18vtkImplicitBoolean3NewEv "libvtkFiltering"
