...
@vcall 79 None Pan ()
@vcall 80 None Dolly ()
@vcall 112 None SetLatLongLines (Int32,)
@vcall 113 Int32 GetLatLongLines ()
@vcall 114 None LatLongLinesOn ()
@vcall 115 None LatLongLinesOff ()
@mcall None SelectRepresentation () _ZN25vtkInteractorStyleTerrain20SelectRepresentationEv "libvtkRendering"
@mcall None CreateLatLong () _ZN25vtkInteractorStyleTerrain13CreateLatLongEv "libvtkRendering"
@mcall None vtkInteractorStyleTerrain_eq (Void,) _ZN25vtkInteractorStyleTerrainaSERKS_ "libvtkRendering"
