...
@scall Ptr{vtkLineSource} vtkLineSourceNew () _ZN13vtkLineSource3NewEv "libvtkGraphics"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN13vtkLineSource8IsTypeOfEPKc "libvtkGraphics"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkLineSource} SafeDownCast (Ptr{vtkObjectBase},) _ZN13vtkLineSource12SafeDownCastEP13vtkObjectBase "libvtkGraphics"
