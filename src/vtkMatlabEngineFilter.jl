...
@scall Ptr{vtkMatlabEngineFilter} vtkMatlabEngineFilterNew () _ZN21vtkMatlabEngineFilter3NewEv "libvtkGraphics"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN21vtkMatlabEngineFilter8IsTypeOfEPKc "libvtkGraphics"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkMatlabEngineFilter} SafeDownCast (Ptr{vtkObjectBase},) _ZN21vtkMatlabEngineFilter12SafeDownCastEP13vtkObjectBase "libvtkGraphics"
