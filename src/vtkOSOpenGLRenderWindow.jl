...
@scall Ptr{vtkOSOpenGLRenderWindow} vtkOSOpenGLRenderWindowNew () _ZN23vtkOSOpenGLRenderWindow3NewEv "libvtkRendering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN23vtkOSOpenGLRenderWindow8IsTypeOfEPKc "libvtkRendering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkOSOpenGLRenderWindow} SafeDownCast (Ptr{vtkObjectBase},) _ZN23vtkOSOpenGLRenderWindow12SafeDownCastEP13vtkObjectBase "libvtkRendering"
