...
@scall Ptr{vtkOpenGLPolyDataMapper} vtkOpenGLPolyDataMapperNew () _ZN23vtkOpenGLPolyDataMapper3NewEv "libvtkRendering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN23vtkOpenGLPolyDataMapper8IsTypeOfEPKc "libvtkRendering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkOpenGLPolyDataMapper} SafeDownCast (Ptr{vtkObjectBase},) _ZN23vtkOpenGLPolyDataMapper12SafeDownCastEP13vtkObjectBase "libvtkRendering"
