...
@scall Ptr{vtkOpenGLProperty} vtkOpenGLPropertyNew () _ZN17vtkOpenGLProperty3NewEv "libvtkRendering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN17vtkOpenGLProperty8IsTypeOfEPKc "libvtkRendering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkOpenGLProperty} SafeDownCast (Ptr{vtkObjectBase},) _ZN17vtkOpenGLProperty12SafeDownCastEP13vtkObjectBase "libvtkRendering"
