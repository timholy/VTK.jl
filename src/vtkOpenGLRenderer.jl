...
@scall Ptr{vtkOpenGLRenderer} vtkOpenGLRendererNew () _ZN17vtkOpenGLRenderer3NewEv "libvtkRendering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN17vtkOpenGLRenderer8IsTypeOfEPKc "libvtkRendering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkOpenGLRenderer} SafeDownCast (Ptr{vtkObjectBase},) _ZN17vtkOpenGLRenderer12SafeDownCastEP13vtkObjectBase "libvtkRendering"
