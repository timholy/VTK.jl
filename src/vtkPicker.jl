cur_class = vtkPicker
@scall Ptr{vtkPicker} vtkPickerNew () _ZN9vtkPicker3NewEv "libvtkRendering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN9vtkPicker8IsTypeOfEPKc "libvtkRendering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkPicker} SafeDownCast (Ptr{vtkObjectBase},) _ZN9vtkPicker12SafeDownCastEP13vtkObjectBase "libvtkRendering"
