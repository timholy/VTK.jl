...
@mcall Ptr{Void} NewInstance () _ZNK11vtkPolyData11NewInstanceEv "libvtkFiltering"
...
@mcall None CopyCells (Ptr{Void}, Ptr{Void}, Ptr{Void}) _ZN11vtkPolyData9CopyCellsEPS_P9vtkIdListP15vtkPointLocator "libvtkFiltering"
...
@mcall None SetVerts (Ptr{Void},) _ZN11vtkPolyData8SetVertsEP12vtkCellArray "libvtkFiltering"
@mcall Ptr{Void} GetVerts () _ZN11vtkPolyData8GetVertsEv "libvtkFiltering"
@mcall None SetLines (Ptr{Void},) _ZN11vtkPolyData8SetLinesEP12vtkCellArray "libvtkFiltering"
@mcall Ptr{Void} GetLines () _ZN11vtkPolyData8GetLinesEv "libvtkFiltering"
@mcall None SetPolys (Ptr{Void},) _ZN11vtkPolyData8SetPolysEP12vtkCellArray "libvtkFiltering"
@mcall Ptr{Void} GetPolys () _ZN11vtkPolyData8GetPolysEv "libvtkFiltering"
@mcall None SetStrips (Ptr{Void},) _ZN11vtkPolyData9SetStripsEP12vtkCellArray "libvtkFiltering"
@mcall Ptr{Void} GetStrips () _ZN11vtkPolyData9GetStripsEv "libvtkFiltering"
...
@mcall None Allocate (Ptr{Void}, vtkIdType, Int32) _ZN11vtkPolyData8AllocateEPS_xi "libvtkFiltering"
@mcall Int32 InsertNextCell (Int32, Int32, Ptr{vtkIdType}) _ZN11vtkPolyData14InsertNextCellEiiPx "libvtkFiltering"
@mcall Int32 InsertNextCell (Int32, Ptr{Void}) _ZN11vtkPolyData14InsertNextCellEiP9vtkIdList "libvtkFiltering"
...
@mcall None GetCellEdgeNeighbors (vtkIdType, vtkIdType, vtkIdType, Ptr{Void}) _ZN11vtkPolyData20GetCellEdgeNeighborsExxxP9vtkIdList "libvtkFiltering"
...
@mcall Int32 GetScalarFieldCriticalIndex (vtkIdType, Ptr{Void}) _ZN11vtkPolyData27GetScalarFieldCriticalIndexExP12vtkDataArray "libvtkFiltering"
