...
@scall Ptr{vtkProgrammableFilter} vtkProgrammableFilterNew () _ZN21vtkProgrammableFilter3NewEv "libvtkGraphics"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN21vtkProgrammableFilter8IsTypeOfEPKc "libvtkGraphics"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkProgrammableFilter} SafeDownCast (Ptr{vtkObjectBase},) _ZN21vtkProgrammableFilter12SafeDownCastEP13vtkObjectBase "libvtkGraphics"
