...
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN9vtkProp3D8IsTypeOfEPKc "libvtkRendering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkProp3D} SafeDownCast (Ptr{vtkObjectBase},) _ZN9vtkProp3D12SafeDownCastEP13vtkObjectBase "libvtkRendering"
