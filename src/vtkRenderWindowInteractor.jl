cur_class = vtkRenderWindowInteractor
...
@vcall 29 Ptr{vtkRenderWindow} GetRenderWindow ()
...
@vcall 47 None SetInteractorStyle (Ptr{vtkInteractorObserver},)
@vcall 48 Ptr{vtkInteractorObserver} GetInteractorStyle ()
...
@vcall 62 None SetPicker (Ptr{vtkAbstractPicker},)
@vcall 63 Ptr{vtkAbstractPicker} GetPicker ()
@vcall 64 Ptr{vtkAbstractPropPicker} CreateDefaultPicker ()
...
@vcall 108 Ptr{vtkRenderer} FindPokedRenderer (Int32, Int32)
