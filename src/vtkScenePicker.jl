...
@scall Ptr{vtkScenePicker} vtkScenePickerNew () _ZN14vtkScenePicker3NewEv "libvtkRendering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN14vtkScenePicker8IsTypeOfEPKc "libvtkRendering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkScenePicker} SafeDownCast (Ptr{vtkObjectBase},) _ZN14vtkScenePicker12SafeDownCastEP13vtkObjectBase "libvtkRendering"
