...
@scall Ptr{vtkSimpleCellTessellator} vtkSimpleCellTessellatorNew () _ZN24vtkSimpleCellTessellator3NewEv "libvtkFiltering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN24vtkSimpleCellTessellator8IsTypeOfEPKc "libvtkFiltering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkSimpleCellTessellator} SafeDownCast (Ptr{vtkObjectBase},) _ZN24vtkSimpleCellTessellator12SafeDownCastEP13vtkObjectBase "libvtkFiltering"
