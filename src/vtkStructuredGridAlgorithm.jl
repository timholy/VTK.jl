...
@scall Ptr{vtkStructuredGridAlgorithm} vtkStructuredGridAlgorithmNew () _ZN26vtkStructuredGridAlgorithm3NewEv "libvtkFiltering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN26vtkStructuredGridAlgorithm8IsTypeOfEPKc "libvtkFiltering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkStructuredGridAlgorithm} SafeDownCast (Ptr{vtkObjectBase},) _ZN26vtkStructuredGridAlgorithm12SafeDownCastEP13vtkObjectBase "libvtkFiltering"
