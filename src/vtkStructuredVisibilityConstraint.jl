...
@scall Ptr{vtkStructuredVisibilityConstraint} vtkStructuredVisibilityConstraintNew () _ZN33vtkStructuredVisibilityConstraint3NewEv "libvtkCommon"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN33vtkStructuredVisibilityConstraint8IsTypeOfEPKc "libvtkCommon"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkStructuredVisibilityConstraint} SafeDownCast (Ptr{vtkObjectBase},) _ZN33vtkStructuredVisibilityConstraint12SafeDownCastEP13vtkObjectBase "libvtkCommon"
