...
@scall Ptr{vtkSynchronizedTemplates2D} vtkSynchronizedTemplates2DNew () _ZN26vtkSynchronizedTemplates2D3NewEv "libvtkGraphics"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN26vtkSynchronizedTemplates2D8IsTypeOfEPKc "libvtkGraphics"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkSynchronizedTemplates2D} SafeDownCast (Ptr{vtkObjectBase},) _ZN26vtkSynchronizedTemplates2D12SafeDownCastEP13vtkObjectBase "libvtkGraphics"
