...
@scall Ptr{vtkTessellatedBoxSource} vtkTessellatedBoxSourceNew () _ZN23vtkTessellatedBoxSource3NewEv "libvtkGraphics"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN23vtkTessellatedBoxSource8IsTypeOfEPKc "libvtkGraphics"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkTessellatedBoxSource} SafeDownCast (Ptr{vtkObjectBase},) _ZN23vtkTessellatedBoxSource12SafeDownCastEP13vtkObjectBase "libvtkGraphics"
