...
@scall Ptr{vtkTexture} vtkTextureNew () _ZN10vtkTexture3NewEv "libvtkRendering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN10vtkTexture8IsTypeOfEPKc "libvtkRendering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkTexture} SafeDownCast (Ptr{vtkObjectBase},) _ZN10vtkTexture12SafeDownCastEP13vtkObjectBase "libvtkRendering"
