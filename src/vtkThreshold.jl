...
@scall Ptr{vtkThreshold} vtkThresholdNew () _ZN12vtkThreshold3NewEv "libvtkGraphics"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN12vtkThreshold8IsTypeOfEPKc "libvtkGraphics"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkThreshold} SafeDownCast (Ptr{vtkObjectBase},) _ZN12vtkThreshold12SafeDownCastEP13vtkObjectBase "libvtkGraphics"
