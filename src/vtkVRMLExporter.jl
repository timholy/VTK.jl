...
@scall Ptr{vtkVRMLExporter} vtkVRMLExporterNew () _ZN15vtkVRMLExporter3NewEv "libvtkRendering"
@vcall 0 Ptr{Uint8} GetClassNameInternal ()
@scall Int32 IsTypeOf (Ptr{Uint8},) _ZN15vtkVRMLExporter8IsTypeOfEPKc "libvtkRendering"
@vcall 1 Int32 IsA (Ptr{Uint8},)
@scall Ptr{vtkVRMLExporter} SafeDownCast (Ptr{vtkObjectBase},) _ZN15vtkVRMLExporter12SafeDownCastEP13vtkObjectBase "libvtkRendering"
